  ...
  return (
    <div id="about" className="w-full bg-themeBlack-dark container flex-col">
      <div className="w-full max-w-[1280px] mx-auto flex flex-col justify-start items-center py-[50px]">
        ...
        <div className="w-[80%] xl:w-full flex flex-col md:flex-row md:gap-0 gap-6 justify-between items-stretch text-[#939191]">
          <p className="basis-[28%] md:text-xl">
          ...
          <div className="basis-[28%] md:text-xl flex flex-col justify-between items-center">
            ...
            <img src={Me} alt="" className="w-[25%] mt-8 mb-0 m-auto" />
          </div>
        </div>
      </div>
      ...
      <div className="w-[50%] flex justify-center items-center gap-10 mx-auto">
        ...
        >
          <Instagram width={isMobile ? 18 : 36} />
        </a>
        <a
          target="_blank"
          rel="noreferrer"
